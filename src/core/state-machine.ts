...
const TRANSITIONS: Readonly<Record<AgentStatus, ReadonlySet<AgentStatus>>> = {
  ...
  idle: new Set(["running", "paused", "closed", "orphaned", "failed"]),
  running: new Set(["idle", "waiting", "retrying", "compacting", "paused", "blocked", "aborting", "completed", "failed", "orphaned"]),
  waiting: new Set(["running", "idle", "paused", "blocked", "aborting", "failed", "orphaned"]),
  retrying: new Set(["running", "paused", "blocked", "aborting", "failed", "orphaned"]),
  compacting: new Set(["running", "paused", "aborting", "failed", "orphaned"]),
  paused: new Set(["queued", "idle", "running", "aborting", "closed", "orphaned", "failed"]),
  blocked: new Set(["running", "paused", "aborting", "failed", "replaced", "closed"]),
